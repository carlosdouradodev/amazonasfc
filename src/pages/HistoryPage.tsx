...
const historyParagraphs = ["Fundado em 23 de maio de 2019 por um grupo de amigos empresários e sediado em Manaus, o Amazonas FC recebe o nome do Estado mais importante da região Norte e o maior em território no País. Com as cores amarelo e preto e com a Onça-pintada como mascote, surpreendeu os manauaras ao conseguir o acesso para a elite do futebol local em menos de seis meses de história.","Logo em seu primeiro ano de existência, o Amazonas venceu a Série B do Estadual de maneira invicta e indiscutível. Em 2022, ao debutar em uma competição nacional, o Aurinegro liderou seu grupo na primeira fase, conquistou o acesso à Série C e terminou o certame com o melhor ataque, a terceira melhor campanha e os dois artilheiros da Quarta Divisão; o meia Rafael Tavares e o atacante Ítalo.","No ano seguinte, a Onça-pintada conquistou duas taças de primeira grandeza; o Campeonato Amazonense 2023 e o Campeonato Brasileiro Série C 2023, o primeiro título nacional não apenas do clube, mas do futebol local, além de ter feito, mais uma vez, o artilheiro do certame; o atacante Sassá, com 18 gols.","Ao participar pela primeira vez da Série B do Brasileiro, em 2024, o Aurinegro fez uma campanha sólida e terminou a competição em 11º lugar, com 52 pontos conquistados. Nesta mesma temporada, chegou à terceira fase da Copa do Brasil e ficou com o vice-campeonato amazonense.","Nesta temporada, a Onça faturou o seu segundo título estadual ao derrotar o Nacional em uma decisão emocionante pelo placar de 2 a 1, com gol marcado nos minutos finais de jogo. Atualmente, a equipe é a única representante do Amazonas na Série B.",
];
...
const valueList = ["Fome de vitória","Nunca desistir","Humildade dentro e fora de campo","Compromisso com o ESG","Deixar um legado",
];
...
export function HistoryPage() {
  ...
  const transitionImageY = useTransform(transitionProgress, [0, 1], prefersReducedMotion ? [0, 0] : [0, 56]);
  const transitionImageScale = useTransform(transitionProgress, [0, 1], prefersReducedMotion ? [1.02, 1.02] : [1.06, 1]);
  const transitionTextY = useTransform(transitionProgress, [0, 1], prefersReducedMotion ? [0, 0] : [18, -18]);
  ...
  return (
    <main id="main-content">
      ...
      <section ref={transitionRef} className="section-shell relative -mt-5 pb-10 pt-0 md:-mt-10">
        <motion.div
          className="relative overflow-hidden rounded-[8px] border border-paper/10 bg-black"
        ...
        >
          <motion.img
            alt=""
            className="absolute inset-0 h-full w-full object-cover object-center opacity-54"
            src={assets.oncaWide}
            style={{ y: transitionImageY, scale: transitionImageScale }}
          />
          <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(5,4,3,0.86)_0%,rgba(5,4,3,0.54)_44%,rgba(5,4,3,0.78)_100%),linear-gradient(180deg,rgba(5,4,3,0.18)_0%,rgba(5,4,3,0.64)_100%)]" />
          <div className="editorial-grid absolute inset-0 opacity-22" />
          <motion.div className="relative grid gap-6 px-6 py-8 md:grid-cols-[180px_1fr] md:items-end md:px-8" style={{ y: transitionTextY }}>
            <div>
              <p className="text-[10px] font-extrabold uppercase tracking-[0.2em] text-yellow/76">Capítulo 01</p>
              <p className="display mt-3 text-[clamp(28px,4vw,52px)] leading-[0.92] text-paper">Ascensão.</p>
            </div>
            <div className="grid gap-4 md:grid-cols-[1fr_auto] md:items-end">
              <p className="max-w-[42ch] text-sm font-semibold leading-7 text-paper/76 md:text-base">
                Da Série B amazonense ao primeiro título nacional do estado em quatro temporadas. A história do clube só funciona quando o ganho esportivo vira narrativa.
              </p>
              <span className="display text-[clamp(20px,3.6vw,42px)] leading-none text-yellow/78">2019 - 2026</span>
            </div>
          </motion.div>
        </motion.div>
      </section>

      <div className="page-shell relative pb-12 pt-0">
      ...
      <MotionSection className="section-shell grid gap-12 py-18 lg:grid-cols-[0.9fr_1.1fr] lg:items-start lg:py-24">
        <div className="overflow-hidden rounded-[8px] border border-paper/12 lg:sticky lg:top-28">
          <img className="aspect-[0.95] w-full object-cover" src={assets.oncaWide} alt="Arte da onça-pintada do Amazonas FC" loading="lazy" decoding="async" />
        </div>
