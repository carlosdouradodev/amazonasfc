import { assets, honors, officialLinks, squad } from "./club.js";
import { serieCStatus, serieCTopScorers, upcomingSerieC } from "./competition.generated.js";
...
const cleanedPosition = String(serieCStatus.position).replaceAll("\u00c2", "");
...
export const sectionPages = {
  "/clube/simbolos": {
    ...
    intro: [
      "Amazonas FC carrega o nome do estado e usa amarelo e preto para manter leitura imediata. O escudo frontal e a Onca-pintada concentram o reconhecimento da marca.",
      "Essa pagina existe para dar coesao ao discurso do clube. O torcedor precisa entender simbolo, cor e linguagem como sistema, nao como ornamentacao solta.",
    ],
    stats: [
    ...
    ctas: [{ label: "Abrir historia", href: "#/clube/historia", external: false }],
  },
  "/clube/titulos": {
    eyebrow: "Clube",
    ...
    intro: [
      "O clube ainda e novo, mas os trofeus ja definem narrativa competitiva. O titulo da Serie C de 2023 e o primeiro titulo brasileiro de um clube amazonense.",
      "Os estaduais de 2023 e 2025 completam a leitura. O Amazonas deixou de ser projeto de acesso e virou referencia local com calendario nacional continuo.",
    ],
    stats: [
  ...
  "/clube/curiosidades": {
    ...
    intro: [
      "Esta secao filtra o que de fato diferencia o Amazonas. O clube nasce em 2019, sobe cedo, conquista titulo nacional em 2023 e vira referencia regional em tempo muito curto.",
      "O ganho aqui e editorial. A pagina ajuda torcida, imprensa e comercial a repetir os mesmos pontos com precisao.",
    ],
    stats: [
    ...
    ctas: [{ label: "Ler historia", href: "#/clube/historia", external: false }],
  },
  "/futebol/profissional": {
    ...
    intro: [
      "A pagina profissional funciona como uma entrada curta para o futebol principal. O torcedor chega aqui para entender momento, proximo jogo e referencias do elenco.",
      "O site ja tem pages mais profundas para Matchday, tabela e elenco. Aqui a funcao e agrupar esse acesso sem virar painel tecnico demais.",
    ],
    stats: [
      { label: "Serie C", value: cleanedPosition },
    ...
    blocks: [
      {
        ...
        columns: "md:grid-cols-2 xl:grid-cols-4",
        items: [
          { kicker: "Tabela", title: "Posicao atual", text: `${cleanedPosition} na Serie C com ${serieCStatus.points} pontos.` },
  ...
  "/futebol/base": {
    ...
    intro: [
      "A base nao precisa parecer pagina esquecida. Ela precisa mostrar pessoas, fluxo de trabalho e um argumento claro de desenvolvimento esportivo.",
      "Esse primeiro corte organiza nomes e funcoes. Quando houver mais material, entram calendario, categorias e resultados.",
    ],
    stats: [
  ...
  "/institucional/estatuto": {
    ...
    intro: [
      "Esta pagina organiza a camada formal do clube. O ideal e publicar versao consolidada do estatuto, data de revisao e contato institucional em um fluxo curto.",
      "Enquanto a versao integral nao entra no site, a area precisa ao menos definir onde o documento oficial sera consultado.",
    ],
    blocks: [
      {
  ...
  "/institucional/transparencia": {
    ...
    intro: [
      "Transparencia nao pede excesso de texto. Pede indice, datas, arquivos e uma hierarquia clara de leitura.",
      "Quando o clube decidir publicar balancos, contratos padrao ou relatorios ESG, esta estrutura ja fica pronta.",
    ],
    blocks: [
      {
  ...
  "/institucional/comercial": {
    ...
    intro: [
      "O clube pode vender melhor quando mostra o que existe. Jogo, camisa, digital, base, conteudo e hospitalidade precisam entrar na mesma leitura.",
      "Aqui o ideal e apresentar propriedades e um canal curto de contato comercial.",
    ],
    blocks: [
      {
  ...
  "/institucional/imprensa": {
    ...
    intro: [
      "A area de imprensa precisa reduzir friccao. Credenciamento, foto oficial, releases e orientacao de cobertura entram em um mesmo fluxo.",
      "O ganho e operacional. Menos pergunta repetida e menos demanda espalhada em canal errado.",
    ],
    blocks: [
      {
    ...
    ctas: [{ label: "Abrir noticias", href: "#/noticias", external: false }],
  },
};
