export function StatCard({ item, label, value }) {
  ...
  return (
    ...
    >
      <span className={`mb-4 flex h-9 w-9 items-center justify-center border text-[10px] font-extrabold uppercase tracking-[0.05em] transition ${featured ? "border-yellow bg-yellow text-black" : "border-paper/14 bg-paper/[0.035] text-yellow group-hover:border-yellow"}`}>
        {mark}
      </span>
