...
import { serieCStandings, serieCStatus, upcomingSerieC } from "../data/competition.generated.js";
...
function MatchCard({ match }) {
  ...
  const competition = (match.competition || match.round || "Série C").toUpperCase();
  const locationLabel =
  ...
  return (
    <article className="group rounded-[8px] border border-paper/10 bg-[#1b1b1b] px-6 py-6 transition-all duration-300 hover:border-yellow/40 hover:shadow-[0_18px_48px_rgba(242,195,25,.08)]">
      ...
      <div className="grid gap-8 lg:grid-cols-[1.95fr_0.95fr]">
        <div>
          <div className="mb-6 flex items-center justify-between gap-4">
            <AccentTitle>Próximos jogos</AccentTitle>
        ...
        <div>
          <div className="mb-6">
            <AccentTitle>Classificação</AccentTitle>
          </div>

          <div className="overflow-hidden rounded-[8px] border border-paper/10 bg-[#1b1b1b]">
            <div className="bg-yellow px-4 py-4 text-sm font-black uppercase text-black">Série C {seasonYear}</div>
