...
import { assets, news } from "../data/club.js";
...
function NewsOverlayCard({ item, featured = false }) {
  ...
  return (
    ...
    >
      <img className="absolute inset-0 h-full w-full object-cover opacity-42 transition duration-500 group-hover:scale-105 group-hover:opacity-52" src={item.image} alt="" />
